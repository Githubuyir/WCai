// Teams Lineups, Formations, Coaches and Real Stats for all 48 World Cup teams

export const REAL_TEAMS_DATA = {
  "MEX": {
    "fifaRank": 15,
    "powerRank": null,
    "isDarkHorse": false,
  ...
  "USA": {
    ...
    "winProb": "2.2%",
    "rating": 83,
    "archetype": "High Press & Direct Verticals",
    "group": "Group D"
  },
  "AUS": {
    "fifaRank": 27,
  ...
  "JPN": {
    ...
    "winProb": "2.0%",
    "rating": 83,
    "archetype": "High Intensity Counter-Press",
    "group": "Group F"
  },
  "SWE": {
    "fifaRank": 38,
  ...
  "FRA": {
    ...
    "winProb": "16.8%",
    "rating": 92,
    "archetype": "Vertical Transitions",
    "group": "Group I"
  },
  "SEN": {
    "fifaRank": 14,
  ...
  "NOR": {
    ...
    "winProb": "1.2%",
    "rating": 79,
    "archetype": "Direct Attacking & Target Play",
    "group": "Group I"
  },
  "IRQ": {
    "fifaRank": 57,
  ...
  "CRO": {
    ...
    "winProb": "2.8%",
    "rating": 83,
    "archetype": "Technical Midfield Control",
    "group": "Group L"
  },
  "GHA": {
    "fifaRank": 73,
...
export const TEAMS_LINEUPS = {
  ALG: {
    name: "Algeria",
    formation: "4-2-3-1",
    coach: "Petkovic",
    lineup: "Zidane; Belghali, Belaid, Bensebaini, Ait-Nouri; Zerrouki, Boudaoui; Mahrez, Aouar, Chaibi, Gouiri"
  },
  KSA: {
    name: "Saudi Arabia",
    formation: "4-3-3",
    coach: "Donis",
    lineup: "Al-Aqidi; Boushal, Tambakti, Al-Amri, Al-Harbi; Kanno, Al-Khaibari, N. Al-Dawsari; Mandash, Al-Buraikan, S. Al-Dawsari"
  },
  ARG: {
    name: "Argentina",
    formation: "4-4-2",
    coach: "Scaloni",
    lineup: "Martinez; Molina, Otamendi, Romero, Tagliafico; Mac Allister, R.De.Paul, Fernandez, G.Simeone; Messi, Alvarez"
  },
  AUS: {
    name: "Australia",
    formation: "5-4-1",
    coach: "Popovic",
    lineup: "Ryan; Italiano, Degenek, Souttar, Circati, Bos; Metcalfe, Devlin, O'Neill, Irankunda; Touré"
  },
  AUT: {
    name: "Austria",
    formation: "4-2-3-1",
    coach: "Rangnick",
    lineup: "A. Schlager; Laimer, Lienhart, Alaba, Mwene; X. Schlager, Seiwald; Wimmer, Baumgartner, Sabitzer; Arnautovic"
  },
  BEL: {
    name: "Belgium",
    formation: "4-2-3-1",
    coach: "Garcia",
    lineup: "Courtois; Castagne, Debast, Theate, De Cuyper; Tielemans, Onana; Doku, De Bruyne, Trossard; R. Lukaku"
  },
  BIH: {
    name: "Bosnia & Herz.",
    formation: "4-4-2",
    coach: "Barbarez",
    lineup: "Vasilj; Dedic, Katic, Muharemovic, Kolasinac; Bajraktarevic, Sunjic, Tahirovic, Memic; Demirovic, Dzeko"
  },
  BRA: {
    name: "Brazil",
    formation: "4-4-2",
    coach: "Ancelotti",
    lineup: "Alisson; Danilo, Marquinhos, Gabriel, Douglas Santos; Luis Henrique, Casemiro, Bruno Guimaraes, Raphinha; Vinicius, Cunha"
  },
  CAN: {
    name: "Canada",
    formation: "4-4-2",
    coach: "Marsch",
    lineup: "Crepeau; Sigur, Bombito, Jones, Laryea; Buchanan, Koné, Eustaquio, Davies; Oluwaseyi, David"
  },
  CPV: {
    name: "Cabo Verde",
    formation: "4-2-3-1",
    coach: "Bubista",
    lineup: "Voziha; Moreira, Lopes, Borges, Lopes Cabral; Lenini, Duarte; Rodrigues, Monteiro, Cabral; Livramento"
  },
  COL: {
    name: "Colombia",
    formation: "4-2-3-1",
    coach: "Lorenzo",
    lineup: "Montero; Munoz, Sanchez, Mina, Mojica; Lerma, Rios; Arias, James, Diaz, Suarez"
  },
  KOR: {
    name: "Korea Republic",
    formation: "4-2-3-1",
    coach: "Hong",
    lineup: "Seung-gyu Kim; Seol, Min-jae Kim, Han-beom Lee, Tae-seok Lee; Wang, Castrop; Kang-in Lee, Jae-sung Lee, Bae; Son"
  },
  CIV: {
    name: "Cote d'Ivoire",
    formation: "4-3-3",
    coach: "Faé",
    lineup: "Fofana; Doué, Koussonou, Ndicka, Konan; Kessié, Sangaré, Oulai; Pepé, Guessand, Diomandé"
  },
  CUR: {
    name: "Curaçao",
    formation: "4-3-3",
    coach: "Advocaat",
    lineup: "Room; Sambo, Van Ejma, Obispo, Floranus; J. Bacuna, Comenancia, L. Bacuna; Chong, Locadia, Gorré"
  },
  CRO: {
    name: "Croatia",
    formation: "4-2-3-1",
    coach: "Dalic",
    lineup: "Livakovic; Stanisic, Sutalo, Caleta-Car, Gvardiol; Sucic, Modric; Pasalic, Kramaric, Perisic, Budimir"
  },
  ECU: {
    name: "Ecuador",
    formation: "4-3-3",
    coach: "Beccacece",
    lineup: "Galindez; Preciado, Ordonez, Pacho, HIncapié; Vite, Caicedo, Castillo; Yeboah, Valencia, Angulo"
  },
  EGY: {
    name: "Egypt",
    formation: "3-4-1-2",
    coach: "Hassan",
    lineup: "El Shenawy; Ibrahim, Abdelmaguif, Rabia; Hany, Ateya, Lasheen, Fatouh; Ashour; Salah, Marmoush"
  },
  FRA: {
    name: "France",
    formation: "4-2-3-1",
    coach: "Deschamps",
    lineup: "Maignan; Koundé, Saliba, Upamecano, Hernandez; Rabiot, Tchouameni; Dembelé, Olise, Doué; Mbappé"
  },
  GER: {
    name: "Germany",
    formation: "4-2-3-1",
    coach: "Tuchel",
    lineup: "Neuer; Kimmich, Tah, Schlotterbeck, Raum; Pavlovic, Goreztka; Sané, Musiala, Wirtz; Havertz"
  },
  GHA: {
    name: "Ghana",
    formation: "3-4-3",
    coach: "Queiroz",
    lineup: "Asare; Adjetei, Seidu, Oppong; Yirenkyi, Sibo, Partey, Mensah; Sulemana, Semenyo, Ayew"
  },
  JPN: {
    name: "Japan",
    formation: "3-4-2-1",
    coach: "Moriyasu",
    lineup: "Suzuki; Tomiyasu, Taniguchi, Itakura; Doan, Endo, Tanaka, Nakamura; Kubo, Ito; Ueda"
  },
  JOR: {
    name: "Jordan",
    formation: "3-4-3",
    coach: "Sellami",
    lineup: "Abulaila; Abu Dahab, Nasib, Al-Arab; Haddad, Al-Rawahbdeh, Al-Rashdan; Abu Taha; Tamari, Olwan, Al-Mardi"
  },
  HAI: {
    name: "Haiti",
    formation: "4-3-3",
    coach: "Migné",
    lineup: "Placide; Arcus, Adé, Duverne, Expérience; Deedson, Bellegarde, Pierre; Isidor, Nazon, Providence"
  },
  ENG: {
    name: "England",
    formation: "4-2-3-1",
    coach: "Tuchel",
    lineup: "Pickford; James, Guehi, Konsa, O'Reilly; Anderson, Rice; Saka, Bellingham, Eze; Kane"
  },
  IRN: {
    name: "IR Iran",
    formation: "4-2-3-1",
    coach: "Ghalenoei",
    lineup: "Beyranvand; Yousefi, Kanaani, Khalilzadeh, Mohammadi; Ezatolahi, Ghoddos; Jahanbakhsh, Ghayedi, Mohebi; Taremi"
  },
  IRQ: {
    name: "Iraq",
    formation: "4-2-3-1",
    coach: "Arnold",
    lineup: "Hassan; Hussein Ali, Sulaka, Tahseen, Doski; Al-Ammari, Bayesh; Ali Jasim, Iqbal, Amyn; Aymen Hussein"
  },
  MAR: {
    name: "Morocco",
    formation: "4-2-3-1",
    coach: "Ouahbi",
    lineup: "Bono; Hakimi, Diop, Aguerd, Salah-Eddine; Ounahi, El Aynaoui; Brahim Diaz, Saibari, Talbi; El Kaabi"
  },
  MEX: {
    name: "Mexico",
    formation: "4-3-3",
    coach: "Aguirre",
    lineup: "Rangel; Sanchez, Montes, Vasquez, Gallardo; Pineda, Alvarez, Fidalgo; Vega, Jimenez, Quinones"
  },
  NOR: {
    name: "Norway",
    formation: "4-3-3",
    coach: "Solbakken",
    lineup: "Nyland; Ryerson, Heggem, Ostigard, Wolfe; Thorstvedt, Berge, Odegaard; Sorloth, Haaland, Nusa"
  },
  NZL: {
    name: "New Zealand",
    formation: "4-2-3-1",
    coach: "Bazele",
    lineup: "Crocombe; Payne, Bindon, Boxall, Cacace; Samenic, Bell; McCowatt, Singh, Garbett; Wood"
  },
  NED: {
    name: "Netherlands",
    formation: "4-2-3-1",
    coach: "Koeman",
    lineup: "Verbruggen; Dumfries, Van Dijk, Aké, Van de Ven; De Jong, Gravenberch; Malen, Reijnders, Gakpo; Depay"
  },
  PAN: {
    name: "Panama",
    formation: "3-4-2-1",
    coach: "Christiansen",
    lineup: "Mosquera; Farina, Andrade, Cordoba; Murillo, Carrasquilla, Godoy, Davis; Barcenas, Diaz; Fajardo"
  },
  PAR: {
    name: "Paraguay",
    formation: "4-4-2",
    coach: "Alfaro",
    lineup: "Gill; Caceres, G. Gomez, Alderete, Alonso; D. Gomez, Ojeda, Bobadilla, Almiron; Enciso, Avalos"
  },
  POR: {
    name: "Portugal",
    formation: "4-3-3",
    coach: "Martinez",
    lineup: "Costa; Cancelo, Ruben Dias, Inacio, Nuno Mendes; Joao Neves, Vitinha, Bruno Fernandes; Bernardo Silva, Cristiano Ronaldo, R.Leao"
  },
  QAT: {
    name: "Qatar",
    formation: "4-3-3",
    coach: "Lopetegui",
    lineup: "Barsham; Al-Oui, Khoukhi, Pedro Miguel, Al-Amin; Boudiaf, Fathy, Laye; Edmilson Junior, Almoez Ali, Afif"
  },
  CZE: {
    name: "Czechia",
    formation: "3-4-2-1",
    coach: "Koubek",
    lineup: "Hornicek; Chaloupek, Hranac, Krejci; Zeleny, Soucek, Darida, Coufal; Provod, Sulc; Schick"
  },
  COD: {
    name: "Congo DR",
    formation: "4-2-3-1",
    coach: "Desabre",
    lineup: "Mpasi; Wan-Bissaka, Mbemba, Tuanzebe, Masuaku; Pickel, Moutoussamy; Bongonda, Kakuta, Wissa; Bakambu"
  },
  SCO: {
    name: "Scotland",
    formation: "4-1-4-1",
    coach: "Clarke",
    lineup: "Gordon; Hickey, Hanley, McKenna, Robertson; Ferguson; Gannon-Doak, Christie, McTominay, McGinn; Adams"
  },
  SEN: {
    name: "Senegal",
    formation: "4-2-3-1",
    coach: "Thiaw",
    lineup: "Mendy; Diatta, Koulibaly, Niakhaté, Jakobs; Idrissa Gueye, Pape Gueye; Ismaila Sarr, Iliman Ndiaye, Mané; Jackson"
  },
  ESP: {
    name: "Spain",
    formation: "4-3-3",
    coach: "De La Fuente",
    lineup: "Raya; Llorente, Cubarsì, Laporte, Cucurella; Pedri, Rodri, Fabian Ruiz; Yamal, Oyarzabal, N. Williams"
  },
  USA: {
    name: "USA",
    formation: "4-3-3",
    coach: "Pochettino",
    lineup: "Freese; Freeman, Richards, Trusty, Antonee Robinson; McKennie, Berhalter, Adams; Weah, Balogun, Pulisic"
  },
  RSA: {
    name: "South Africa",
    formation: "4-2-3-1",
    coach: "Bross",
    lineup: "Williams; Mudau, Sibisi, Ndamane, Modiba; Sithole, Mokoena; Apollis, Zwane, Mofokeng; Foster"
  },
  SWE: {
    name: "Sweden",
    formation: "3-4-2-1",
    coach: "Potter",
    lineup: "Nordfeldt; Starfelt, Lagerbielke, Lindelof; Svensson, Karlstrom, Ayari, Gudmundsson; Nygren, Elanga; Gyokeres"
  },
  SUI: {
    name: "Switzerland",
    formation: "4-3-3",
    coach: "Yakin",
    lineup: "Kobel; Widmer, Akanji, Elvedi, Rodriguez; Freuler, Xhaka, Rieder; Ndoye, Embolo, Vargas"
  },
  TUN: {
    name: "Tunisia",
    formation: "4-3-3",
    coach: "Lamouchi",
    lineup: "Dahmen; Valery, Bronn, Talbi, Abdi; Gharbi, Skhiri, Hannibal; Achouri, Mastouri, Tounekti"
  },
  TUR: {
    name: "Türkiye",
    formation: "3-4-2-1",
    coach: "Montella",
    lineup: "Cakir; Demiral, Kabak, Bardakci; Celik, Calhanoglu, Kokcu, Ozer; Guler, Yildiz; Akturkoglu"
  },
  URU: {
    name: "Uruguay",
    formation: "4-3-3",
    coach: "Bielsa",
    lineup: "Rochet; Valera, Gimenez, Araujo, Olivera; Valverde, Ugarte, Bentancur; Canobbio, Nunez, Rodriguez"
  },
  UZB: {
    name: "Uzbekistan",
    formation: "3-4-2-1",
    coach: "Cannavaro",
    lineup: "Nematov; Abdullaev, Ashurmatov, Khusanov; Sayfiev, Shukurov, Khamrobekov, Nasrullaev; Ganiev, Urunov; Shomurodov"
  }
};

// Pre-authored detailed tactical dossiers for top 12 teams
export const PRE_AUTHORED_TEAMS = {
      'BRA': {
        name: "Brazil",
        fifaRank: 6,
        powerRank: 5,
...
// Procedural generator to create completely unique, context-rich dossiers for the other 36 teams
export function generateProceduralTeamData(code) {
  const lineupInfo = TEAMS_LINEUPS[code];
  const realData = REAL_TEAMS_DATA[code] || {};
  if (!lineupInfo) return null;

  const name = lineupInfo.name;
  const formation = lineupInfo.formation;
  const coach = lineupInfo.coach;
  const players = parsePlayers(lineupInfo.lineup);

  // Extract actual players from starts (e.g. GK, key defender, playmaker, forward)
  const gk = players[0] || "Key Goalkeeper";
  const def = players[2] || players[1] || "Defensive Anchor";
  const mid = players[5] || players[6] || "Midfield General";
  const fwd = players[players.length - 1] || "Goal Threat";

  const style = realData.archetype || "Balanced Possession";

  // Context-rich unique summaries containing actual coach and player names
  const overview = `Under coach ${coach}, ${name} deploys a highly organized ${formation} shape playing a ${style.toLowerCase()} style. The tactical focus coordinates transitions through playmaker ${mid} while utilizing the pace and space-creation of ${fwd} in the final third.`;

  const buildup = `Initiates progress from deep defensive zones under ${coach}. Center-backs spread wide to form passing channels, looking to feed ${mid} to transition play cleanly into the opponent's half.`;
  const attack = `Constructs attacking moves using ${style.includes("Wing") || style.includes("Cross") ? "rapid switches of play and overlapping fullbacks" : "patient, short passing combinations through central zones"}. Looks to slip ${fwd} behind the defensive line.`;
  const defense = `Establishes ${style.includes("Press") ? "an intensive counter-pressing screen to force immediate turnovers" : "a disciplined mid-block defensive block to deny central passing channels"}. ${def} organizes the backline structural positioning.`;
  const transition = `Exploits transitional spaces rapidly upon recovery. Plays direct vertical routes utilizing the acceleration of striker ${fwd} to catch the opponent's rest defense off guard.`;
  const setpieces = `Prioritizes target delivery from corners and free-kicks, utilizing the height and physical strength of defender ${def} inside the box.`;
  const weakness = `Can show vulnerability to quick counter-attacks behind fullbacks when committing players forward to support ${fwd}'s attacking transitions.`;

  const metrics = {
    attack: realData.rating + (code.charCodeAt(0) % 5) - 2,
    control: realData.rating + (code.charCodeAt(1) % 5) - 2,
    solidity: realData.rating + (code.charCodeAt(2) % 5) - 2,
    resistance: realData.rating + (code.charCodeAt(0) % 4) - 2,
    transitions: realData.rating + (code.charCodeAt(1) % 4) - 2,
    depth: realData.rating + (code.charCodeAt(2) % 6) - 3
  };

  const keyPlayers = [
    { name: fwd, role: "Striker / Forward", score: realData.rating + 4, impact: `Provides the primary goal threat and final-third presence, coordinating runs behind the defensive line.` },
    { name: mid, role: "Midfield Playmaker", score: realData.rating + 2, impact: `Controls passing tempos, links defensive blocks to attack, and creates chances under pressure.` },
    { name: def, role: "Defensive Pillar", score: realData.rating + 1, impact: `Organizes the defensive shape, wins crucial physical duels, and initiates play from deep.` }
  ];

  const hash = code.split('').reduce((acc, char) => acc + char.charCodeAt(0), 0);
  const sim1Code = (hash % 2 === 0) ? "ESP" : "BRA";
  const sim2Code = (hash % 3 === 0) ? "FRA" : "POR";
  const sim3Code = (hash % 5 === 0) ? "ARG" : "NED";

  return {
    name,
    fifaRank: realData.fifaRank,
    powerRank: realData.powerRank,
    group: realData.group,
    winProb: realData.winProb,
    qualProb: realData.qualProb,
    rating: realData.rating,
    isDarkHorse: realData.isDarkHorse,
    heroImage: code,
    archetype: style,
    archetypeDesc: `A customized ${style.toLowerCase()} system designed to optimize the strengths of ${name}'s key players.`,
    tags: [style, `${formation} Shape`, `Coach ${coach}`],
    overview,
    formation,
    startingXI: getStartingXI(code),
    metrics,
    tactics: { buildup, attack, defense, transition, setpieces, weakness },
    players: keyPlayers,
    form: realData.form,
    goalsScored: realData.goalsScored,
    goalsConceded: realData.goalsConceded,
    cleanSheets: realData.cleanSheets,
    momentum: [realData.rating - 10, realData.rating - 5, realData.rating, realData.rating + 5, realData.rating + 3],
    similar: [
      { name: sim1Code === "ESP" ? "Spain" : "Brazil", code: sim1Code, archetype: sim1Code === "ESP" ? "Possession Dominator" : "Lateral Wing Overload", sim: 80 + (hash % 15) },
      { name: sim2Code === "FRA" ? "France" : "Portugal", code: sim2Code, archetype: sim2Code === "FRA" ? "Transition Predator" : "Technical Possession", sim: 78 + (hash % 14) },
      { name: sim3Code === "ARG" ? "Argentina" : "Netherlands", code: sim3Code, archetype: sim3Code === "ARG" ? "Fluid Possession Block" : "Fluid Possession Block", sim: 75 + (hash % 18) }
    ]
  };
}

export const teamsDatabase = {};
Object.keys(TEAMS_LINEUPS).forEach(code => {
  if (PRE_AUTHORED_TEAMS[code]) {
    const pre = PRE_AUTHORED_TEAMS[code];
    const real = REAL_TEAMS_DATA[code] || {};
    teamsDatabase[code] = {
      ...pre,
      fifaRank: real.fifaRank,
      powerRank: real.powerRank,
      group: real.group,
      winProb: real.winProb,
      qualProb: real.qualProb,
      rating: real.rating,
      isDarkHorse: real.isDarkHorse,
      form: real.form,
      goalsScored: real.goalsScored,
      goalsConceded: real.goalsConceded,
      cleanSheets: real.cleanSheets,
      formation: TEAMS_LINEUPS[code].formation,
      startingXI: getStartingXI(code),
    };
  } else {
    teamsDatabase[code] = generateProceduralTeamData(code);
  }
});

export function getStartingXIForFormation(formation, players) {
  const normForm = formation ? formation.replace(/\s+/g, '') : '4-3-3';
  let layout = [];
  ...
  return layout.map((pos, idx) => ({
    name: players[idx] || `Player ${idx + 1}`,
    role: pos.role,
    x: pos.x,
    y: pos.y,
    // Set captain deterministically (GK is index 0, CB/DM is usually index 2 or 6)
    isCaptain: idx === 2
  }));
}

export function parsePlayers(lineupStr) {
  if (!lineupStr) return [];
  return lineupStr
    .split(/[;,]/)
    .map(p => p.trim())
...
export function getStartingXI(code) {
  const team = TEAMS_LINEUPS[code];
  if (!team) return [];
  const players = parsePlayers(team.lineup);
  return getStartingXIForFormation(team.formation, players);
}
